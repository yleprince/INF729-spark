...
import spark.implicits._
    ...
    // a) Chargement dans un dataframe
    val df = spark
      .read
      .option("header", "true")
      .option("inferSchema", "true")
      .option("nullValue", "false")
      .csv("/Users/Marion/Documents/MSBigData/Cours/Période1/INF729/TP_ParisTech_2017_2018_starter/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/Marion/Documents/MSBigData/Cours/Période1/INF729/TP_ParisTech_2017_2018_starter/prepared_trainingset")
